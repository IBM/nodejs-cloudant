...
- Go into the /nodejs-cloudant/terraform/simple-kube directory and replace the variable value for "ibmcloud_api_key" with your key in variables.tf file and other variables as per your specifications.
